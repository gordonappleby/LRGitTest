# 1 "c:\\data\\loadrunnerscripts\\includemalloctest\\\\combined_Includemalloctest.c"
...
# 1 "c:\\data\\loadrunnerscripts\\includemalloctest\\\\combined_Includemalloctest.c" 2
...
# 2 "c:\\data\\loadrunnerscripts\\includemalloctest\\\\combined_Includemalloctest.c" 2
...
# 3 "c:\\data\\loadrunnerscripts\\includemalloctest\\\\combined_Includemalloctest.c" 2
...
vuser_init()
{
	...
	if((sBuf = (char *)malloc((strlen(sGroupname) + 7)* sizeof(char))) == 0){
...
void fTestMe(char* sVar){
	...
	if((sBuf = (char *)malloc((strlen(sVar) + strlen(" was a bar fighter") + 2)* sizeof(char))) == 0){
		lr_error_message("Out of memory error");
	}else{
...
void fCaptureScreen (char* sTitleLeftBound, char* sTitleRightBound){
	...
	if((sLB = (char *)malloc((strlen(sTitleLeftBound) + strlen("LB/IC=") + 2)* sizeof(char))) == 0){
		lr_error_message("Out of memory error");
		lr_exit(0,1);
	}else{
	...
	if((sRB = (char *)malloc((strlen(sTitleRightBound) + strlen("RB/IC=") + 2)* sizeof(char))) == 0){
		lr_error_message("Out of memory error");
		lr_exit(0,1);
	}else{
...
# 4 "c:\\data\\loadrunnerscripts\\includemalloctest\\\\combined_Includemalloctest.c" 2
...
# 5 "c:\\data\\loadrunnerscripts\\includemalloctest\\\\combined_Includemalloctest.c" 2
...
# 6 "c:\\data\\loadrunnerscripts\\includemalloctest\\\\combined_Includemalloctest.c" 2
